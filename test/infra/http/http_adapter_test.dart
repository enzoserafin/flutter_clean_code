...
import 'package:flutter_clean_code/infra/http/http.dart';
...
void main() {
  ...
  group('post', () {
    ...
    void mockResponse(int statusCode,
        {String body = '{"any_key":"any:_value"}'}) {
    ...
    test('Should return data if post returns 200', () async {
      ...
      expect(response, {'any_key': 'any:_value'});
    });
  ...
  group('put', () {
    ...
    test('Should call put with correct values', () async {
      await sut
          .request(url: url, method: 'put', body: {'any_key': 'any:_value'});
